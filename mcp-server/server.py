...
from prompts import daily_plan, prioritize_tasks, weekly_review  # noqa: E402
...
mcp = FastMCP(
    ...
    instructions=(
        ...
        "get_task / get_all_tasks / get_task_stats) for any mutation, by-id lookup, "
        "or aggregation. Use resources (tasks://all, tasks://completed, tasks://today, "
        "tasks://in-progress, tasks://overdue, tasks://high-priority) for read-only "
        "browsing. Prompts /daily-plan, /prioritize-tasks, and /weekly-review help "
        "plan and rank work."
    ),
)
